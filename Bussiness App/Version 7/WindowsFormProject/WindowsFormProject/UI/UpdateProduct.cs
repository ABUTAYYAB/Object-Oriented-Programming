        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Name != "")
                {
                    ...
                    {
                        if (UserValidation.IsConvertibleToDouble(price) && UserValidation.IsConvertibleToDouble(quantity))
                        {
                            ...
                            if (check)
                            {
                                ...
                                if (discount != "")
                                {
                                    ...
                                    {
                                        MessageBox.Show("Enter valid integer Discount ", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                    }
                                }
                                ClearData();
                                LoadGridBox();
