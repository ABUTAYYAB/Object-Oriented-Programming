        ...
        private void guna2Button1_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (username != "")
                {
                    ...
                    {
                        if (UserValidation.IsConvertibleToDouble(Salary) && UserValidation.IsConvertibleToDouble(Bonus))
                        {
                        ...
                        {
                            MessageBox.Show("Enter  salary and Bonus in integers.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        }
                    }
                    else
                    {
