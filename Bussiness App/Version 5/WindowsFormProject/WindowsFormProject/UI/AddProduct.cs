    ...
    public partial class AddProduct : UserControl
    {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if(UserValidation.IsStringValid(Name)&& UserValidation.IsStringValid(Price) && UserValidation.IsStringValid(quantity) && UserValidation.IsStringValid(description) && UserValidation.IsStringValid(discount))
                    {
